...
syn keyword wipTypes bool f32 f64 i8 i16 i32 i64 isize str type u8 u16 u32 u64 usize
syn match wipLineComment /#.*$/
syn region wipBlockComment start=/#!/ end=/!#/ contains=wipBlockComment
syn match wipNumericConstants /\<\(0b[01_]\+\|0o[0-7_]\+\|[0-9][0-9_]*\(\.[0-9_]\+\)*\(e-\?[0-9_]\+\)*\|0x[0-9A-Fa-f_]\+\)\>/
...
hi def link wipNumericConstants Constant
